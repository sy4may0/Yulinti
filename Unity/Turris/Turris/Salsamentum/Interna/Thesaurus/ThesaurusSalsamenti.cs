...
namespace Yulinti.Unity.Turris {
    ...
    internal sealed class ThesaurusSalsamenti {
        ...
        public ThesaurusSalsamenti() {
            _dataServata = new DatumServatum[ConstansTurris.MaximusNumerusDatumServatum];
            _revisio = 0;
        }
        ...
        private int LegereIDVacantem() {
            for (int i = 0; i < ConstansTurris.MaximusNumerusDatumServatum; i++) {
        ...
        private bool VaridareID(int idDatumServatum) {
            if ((uint)idDatumServatum >= (uint)ConstansTurris.MaximusNumerusDatumServatum) return false;
            return true;
        }
        ...
        public int Creare() {
            ...
            SalsamentumDTO salsamentum = new SalsamentumDTO(
                idDatumServatum, ConstansTurris.VersioSalsamentum, _revisio, DateTime.UtcNow.ToString("yyyy-MM-dd HH:mm:ss")
            );
        ...
        private string ParatioServandi(
            ...
            int versio = ConstansTurris.VersioSalsamentum;
