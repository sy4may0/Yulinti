...
namespace Yulinti.Imperium.Anchora {
    public sealed class AnchoraInput : MonoBehaviour, IAnchora, IAnchoraInput {
        ...
        public bool Validare() {
            bool result = true;
            if (_moveInput == null) {
                Carnifex.Intermissio(LogTextus.AnchoraInput_ANCHORAINPUT_MOVEINPUT_NULL);
                result = false;
            }
            if (_sprintInput == null) {
                Carnifex.Intermissio(LogTextus.AnchoraInput_ANCHORAINPUT_SPRINTINPUT_NULL);
                result = false;
            }
            if (_crouchInput == null) {
                Carnifex.Intermissio(LogTextus.AnchoraInput_ANCHORAINPUT_CROUCHINPUT_NULL);
                result = false;
            }
            if (_click == null) {
                Carnifex.Intermissio(LogTextus.AnchoraInput_ANCHORAINPUT_CLICKINPUT_NULL);
                result = false;
            }
            if (_clickRight == null) {
                Carnifex.Intermissio(LogTextus.AnchoraInput_ANCHORAINPUT_CLICKRIGHTINPUT_NULL);
                result = false;
            }
            if (_submit == null) {
                Carnifex.Intermissio(LogTextus.AnchoraInput_ANCHORAINPUT_SUBMITINPUT_NULL);
                result = false;
            }
            if (_cancel == null) {
                Carnifex.Intermissio(LogTextus.AnchoraInput_ANCHORAINPUT_CANCELINPUT_NULL);
                result = false;
            }
            if (_navigate == null) {
