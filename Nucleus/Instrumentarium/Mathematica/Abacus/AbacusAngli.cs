...
namespace Yulinti.Nucleus.Instrumentarium {
    public sealed class AbacusAnguli {
        ...
        public AbacusAnguli(
            ...
            if (angulusMinimusRad >= angulusMediusRad ||
                ...
                Carnifex.Intermissio(LogTextus.AbacusAnguli_ABACUSANGLI_INVALID_ANGULUS);
            }
            ...
            if (praeruptioAnguli <= 0f) {
                Carnifex.Intermissio(LogTextus.AbacusAnguli_ABACUSANGLI_INVALID_PRAERUPTIO_ANGULI);
            }
