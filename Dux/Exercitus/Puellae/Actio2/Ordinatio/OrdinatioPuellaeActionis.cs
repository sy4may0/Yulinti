...
namespace Yulinti.Dux.Exercitus {
    ...
    internal readonly struct OrdinatioPuellaeActionis {
        ...
        private readonly OrdinatioPuellaeMotus2 _motus;
        private readonly OrdinatioPuellaeNavmesh _navmesh;

        private OrdinatioPuellaeActionis(OrdinatioPuellaeMotus2 motus) {
        ...
        public static OrdinatioPuellaeActionis FromMotus(OrdinatioPuellaeMotus2 motus) {
            return new(motus);
        } 
        ...
        public OrdinatioPuellaeMotus2 Motus {
            get {
        ...
        public void Match(
            Action<OrdinatioPuellaeMotus2> motus,
