...
namespace Yulinti.Dux.Miles {
    internal sealed class StatusCursus : IStatusCorporis {
        private readonly ThesaurusPuellaeStatuumGlobalis _thesaurusGlobalis;
        private readonly ThesaurusPuellaeStatusCursus _thesaurusStatus;
        ...
        public StatusCursus(
            ...
            ThesaurusPuellaeStatusCursus thesauriPuellaeStatusCursus,
            ...
            _thesaurusStatus = thesauriPuellaeStatusCursus;
        ...
        public IDStatus MutareStatum(IResFuluidaMotusLegibile resFuluidaMotus) {
            if(
                _osInputMotusLeg.LegoMotus.LengthSquared() <= _thesaurusGlobalis.LimenInputQuadratum ||
