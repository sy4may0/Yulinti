...
namespace Yulinti.CharacterControllSuite
{
    public struct MovePlan {
        ...
        public float ControllerHeightFix;
        public float ControllerCenterFix;
    }
    ...
    public static class MoveMotionPlanner
    {
        ...
        /// 垂直速度の計画（ジャンプ無し）
        public static float PlanVerticalSpeed(
            bool isGrounded,               // 接地
        ...
        public static float PlanYawFollowCamera(
            CameraProvider cam,
            Vector2 move,
            float currentYawDeg,
            ref float yawVelRef,
    ...
    public static class MoveApplier
    {
        ...
        public static void ApplyHorizontalMove(CharacterController controller, float horizontalSpeed, float deltaTime)
        {
        ...
        /// 垂直移動のみ適用
        public static void ApplyVerticalMove(CharacterController controller, float verticalSpeed, float deltaTime)
        {
