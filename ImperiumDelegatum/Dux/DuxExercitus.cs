...
namespace Yulinti.ImperiumDelegatum.Exercitus {
    internal sealed class DuxExercitus : IDuxExercitus {
        ...
        public DuxExercitus(
            ...
            IReadOnlyList<ICenturioLiberabilis> centurioLiberabilis
        ) {
            ...
            _centurioLiberabilis = centurioLiberabilis.ToArray();
        }
        ...
        public void Liberare() {
            foreach (ICenturioLiberabilis centurio in _centurioLiberabilis) {
                centurio.Liberare();
            }
        }
    }
