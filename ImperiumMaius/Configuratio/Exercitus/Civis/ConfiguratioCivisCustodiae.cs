...
namespace Yulinti.ImperiumMaius.Configuratio {
    [CreateAssetMenu(fileName = "ConfiguratioCivisCustodiae", menuName = "Yulinti/Configuratio/Exercitus/Civis/ConfiguratioCivisCustodiae")]
    public sealed class ConfiguratioCivisCustodiae : ScriptableObject, IConfiguratioCivisCustodiae {
        [Header("視認度上昇倍率 (乗算値)")]
